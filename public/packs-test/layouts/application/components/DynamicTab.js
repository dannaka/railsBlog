...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_router_es_Router__ = __webpack_require__(108);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_prop_types__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__matchPath__ = __webpack_require__(109);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Router__ = __webpack_require__(108);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_router_es_matchPath__ = __webpack_require__(109);
// Written in this round about way for babel-transform-imports
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_immutable__ = __webpack_require__(208);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__material_tabs_tab_constants__ = __webpack_require__(113);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__material_tabs_tab_foundation__ = __webpack_require__(211);
...
var MATCHES = __WEBPACK_IMPORTED_MODULE_4__material_ripple__["c" /* util */].getMatchesProperty(HTMLElement.prototype);

var DynamicTab = function (_React$Component) {
  _inherits(DynamicTab, _React$Component);
  ...
  function DynamicTab() {
    ...
    _classCallCheck(this, DynamicTab);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DynamicTab.__proto__ || Object.getPrototypeOf(DynamicTab)).call.apply(_ref, [this].concat(args))), _this), Object.defineProperty(_this, 'state', {
      enumerable: true,
      writable: true,
      value: {
        ids: new __WEBPACK_IMPORTED_MODULE_3_immutable__["Set"](),
        classes: new __WEBPACK_IMPORTED_MODULE_3_immutable__["Set"](['mdc-tab']),
        rippleCss: new __WEBPACK_IMPORTED_MODULE_3_immutable__["Map"]()
      }
    }), Object.defineProperty(_this, 'foundation', {
      enumerable: true,
      writable: true,
      value: new __WEBPACK_IMPORTED_MODULE_6__material_tabs_tab_foundation__["a" /* default */]({
        ...
        registerInteractionHandler: function registerInteractionHandler(type, handler) {
          _this.refs.root.addEventListener(type, handler);
        },
        deregisterInteractionHandler: function deregisterInteractionHandler(type, handler) {
          _this.refs.root.removeEventListener(type, handler);
        },
        getOffsetWidth: function getOffsetWidth() {
          return _this.refs.root.offsetWidth;
        },
        getOffsetLeft: function getOffsetLeft() {
          return _this.refs.root.offsetLeft;
        },
        notifySelected: function notifySelected() {
          return _this.emit(__WEBPACK_IMPORTED_MODULE_6__material_tabs_tab_foundation__["a" /* default */].strings.SELECTED_EVENT, { tab: _this }, true);
        }
      })
    }), Object.defineProperty(_this, 'rippleFoundation', {
      enumerable: true,
      writable: true,
      value: new __WEBPACK_IMPORTED_MODULE_4__material_ripple__["b" /* MDCRippleFoundation */](Object.assign(__WEBPACK_IMPORTED_MODULE_4__material_ripple__["a" /* MDCRipple */].createAdapter(_this), {
        browserSupportsCssVars: function browserSupportsCssVars() {
          return __WEBPACK_IMPORTED_MODULE_4__material_ripple__["c" /* util */].supportsCssVariables(window);
        },
        isUnbounded: function isUnbounded() {
          return false;
        },
        isSurfaceActive: function isSurfaceActive() {
          return _this.refs.root[MATCHES](':active');
        },
        ...
        registerInteractionHandler: function registerInteractionHandler(type, handler) {
          _this.refs.root.addEventListener(type, handler, __WEBPACK_IMPORTED_MODULE_4__material_ripple__["c" /* util */].applyPassive());
        },
        deregisterInteractionHandler: function deregisterInteractionHandler(type, handler) {
          _this.refs.root.removeEventListener(type, handler, __WEBPACK_IMPORTED_MODULE_4__material_ripple__["c" /* util */].applyPassive());
        },
  ...
  _createClass(DynamicTab, [{
    ...
    value: function componentDidMount() {
      var propsIds = this.props.ids;
      propsIds = propsIds.split(' ').filter(function (v) {
        return !!v;
      });
      var propsIdsSet = new __WEBPACK_IMPORTED_MODULE_3_immutable__["Set"](propsIds);

      var propsClasses = this.props.classes;
      propsClasses = propsClasses.split(' ').filter(function (v) {
        return !!v;
      });
      var propsClassesSet = new __WEBPACK_IMPORTED_MODULE_3_immutable__["Set"](propsClasses);
    ...
    value: function componentDidUpdate() {
      ...
      if (this.refs.root) {
        this.state.rippleCss.forEach(function (v, k) {
          _this2.refs.root.style.setProperty(k, v);
        });
      }
    }
  }, {
    ...
    value: function initialSyncWithDOM() {
      this.isActive = this.refs.root.classList.contains(__WEBPACK_IMPORTED_MODULE_5__material_tabs_tab_constants__["a" /* cssClasses */].ACTIVE);
    }
  }, {
    key: 'measureSelf',
...
Object.defineProperty(DynamicTab, 'propTypes', {
  enumerable: true,
  writable: true,
  value: {
...
Object.defineProperty(DynamicTab, 'defaultProps', {
  enumerable: true,
  writable: true,
  value: {
    ids: '',
...
/* harmony default export */ __webpack_exports__["default"] = (DynamicTab);
